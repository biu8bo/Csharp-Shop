...
namespace Interceptor
{
    ...
    public class Log4NetHelper
    {
        ...
        private Log4NetHelper(ILog log4NetInstance)
        {
        ...
        public static Log4NetHelper GetLogger(string configName)
        {
            ...
            return new Log4NetHelper(logger);
        }

        /// <summary>
        /// Gets the default.
        /// </summary>
        public static Log4NetHelper Default
        {
            get
            {
