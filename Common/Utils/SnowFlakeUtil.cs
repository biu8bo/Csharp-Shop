    ...
    public class SnowFlakeUtil
    {
        ...
        public long nextId()
        {
            lock (this)
            {
                ...
                { //同一微妙中生成ID
                    SnowFlakeUtil.sequence = (SnowFlakeUtil.sequence + 1) & SnowFlakeUtil.sequenceMask; //用&运算计算该微秒内产生的计数是否已经到达上限
                ...
                long nextId = (timestamp - twepoch << timestampLeftShift) | SnowFlakeUtil.workerId << SnowFlakeUtil.workerIdShift | SnowFlakeUtil.sequence;
                return nextId;
            }
        }
